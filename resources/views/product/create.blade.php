...
<div class="container mt-4">
  <div class="row justify-content-center">
    ...
    <div class="mb-2">
        ...
        <input type="text" class="form-control form-control-sm rounded-2" id="title" name="name">
    </div>

    <div class="mb-2">
        <label for="content" class="form-label small">discraption</label>
        <textarea class="form-control form-control-sm rounded-2" id="content" name="discraption" rows="3"></textarea>
    </div>
...
@foreach($products as $product)
    <tr>
        ...
        <td class="text-truncate" style="max-width: 200px;">{{ $product->discraption }}</td>
            <td><div class="d-flex align-items-center gap-1"><a href="{{ route('product.edit',$product->id) }}" class="btn btn-warning btn-sm">Edit</a>
